...
import { Box, Text, Card, Tag, Button, IconButton, Flex, DataGrid } from "@enbdleap/react-ui";
...
const Dashboard: React.FC = () => {
    ...
    const getCardDetails = (category: string) => {
        switch (category) {
            case 'pending-all':
                return {
                    count: dashboardState.data?.allTransaction,
                    amount: dashboardState.data?.individualWithInBankAmount + dashboardState.data?.individualTelegraphicAmount + dashboardState.data?.filesAmount
                };
            case 'telegraphics':
                return {
                    count: dashboardState.data?.individualTelegraphicTransaction,
                    amount: dashboardState.data?.individualTelegraphicAmount
                };
            case 'withinbank':
                return {
                    count: dashboardState.data?.individualWithInBankTransaction,
                    amount: dashboardState.data?.individualWithInBankAmount
                };
            default:
